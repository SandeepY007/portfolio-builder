            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <main class="max-w-lg mt-10 mx-auto py-6 rounded-xl  mb-11">
                    <div class="max-w-lg mt-10 mx-auto border border-gray-500 p-6 rounded-xl bg-gray-100">
                        <h1 class="text-center text-xl font-bold mb-6">Introduction</h1>
                        <form action="{{ route('introduction.update',$intros->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            @include('portfolio.introduction.form')
                        </form>
