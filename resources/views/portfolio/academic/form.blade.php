<div class="mb-6">
    ...
    <input type="text" name="course" id="course" class="border border-gray-400 p-2 w-full" value="{{$academics->course}}">
...
<div class="mb-6">
    ...
    <input type="date" name="started_at" id="started_at" class="border border-gray-400 p-2 w-full" value="{{$academics->started_at}}">
    <span class="text-sm text-red-500">
        @error('started_at')
            {{ $message }}
        @enderror
...
<div class="mb-6">
    ...
    <input type="date" name="ends_at" id="ends_at" class="border border-gray-400 p-2 w-full" value="{{$academics->ends_at}}">
    <span class="text-sm text-red-500">
        @error('ends_at')
            {{ $message }}
        @enderror
...
<div class="mb-6">
    ...
    <input type="text" name="institute_name" id="institute_name" class="border border-gray-400 p-2 w-full" value="{{$academics->institute_name}}">
    <span class="text-sm text-red-500">
...
<div class="mb-6">
    ...
    <input type="percentage" name="percentage" id="percentage" class="border border-gray-400 p-2 w-full" value="{{$academics->percentage}}">
    <span class="text-sm text-red-500">
        @error('percentage')
            {{ $message }}
        @enderror
